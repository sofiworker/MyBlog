 ...
 * @description 评论图片上传
 */
public class CommentImgAction extends ActionSupport {

    private static final long serialVersionUID = 758711769594394011L;
    ...
    public String commentImg() throws Exception{
        ...
        out.close();
        String uploadPath = ServletActionContext.getServletContext().getRealPath("/upload/commentImg/");
    ...
    private String getUrl() throws UnknownHostException {
        ...
        return "http://"+host + ":" + Constants.PORT + "/upload/commentImg/" + newName;
    }
}
