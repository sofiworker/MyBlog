...
public class HeadImgAction extends ActionSupport {
    ...
    private static final long serialVersionUID = -6651834535884742417L;
    ...
    public String headImg() throws Exception{
        ...
        g.drawImage(src, 0, 0, 80, 80, null);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        ImageIO.write(img, getSuffixName(), out);
        byte[] b = out.toByteArray();
        out.close();
        String uploadPath = ServletActionContext.getServletContext().getRealPath("/upload/headImg/");
    ...
    private String getUrl() throws UnknownHostException {
        ...
        return "http://"+host + ":" + Constants.PORT + "/upload/headImg/" + newName;
    }
}
